...
export default function TrueLobby() {
  ...
  const [joinHostVideo, setJoinHostVideo] = useState(false);
  const [joinPlayerVideo, setJoinPlayerVideo] = useState<{
    [key: string]: boolean;
  }>({});
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-center text-white/50">
                    ...
                    {videoRoomCreated &&
                      ...
                      !joinHostVideo && (
                        <button
                          onClick={() => setJoinHostVideo(true)}
                          className="mt-4 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-arabic"
                        >
                          انضم للفيديو
                        </button>
                      )}
